...
while run:
    ...
    if (p1['follower_count']>p2['follower_count'] and guess.lower()=="a") or (p1['follower_count']<p2['follower_count'] and guess.lower()=="b"):
        correct_score +=1
        print(f"\naCorrect! Your current score is: {correct_score}.\n\n")
    else:
        run = False
        print(f"\nIncorrect, your final score is {correct_score}.")
